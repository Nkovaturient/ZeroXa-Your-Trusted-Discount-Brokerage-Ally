  ...
  return (
    ...
    <footer className="p-5">
      <div className="row p-5 border-top">
        ...
        <div className="col" style={{lineHeight: '0.96cm'}}>
          <p style={{fontWeight: '700', fontSize: '18px'}}>Company</p>
          <a href="#">
            About
          </a>
          <br />
        ...
        <div className="col" style={{lineHeight: '0.96cm'}}>
          <p style={{fontWeight: '700', fontSize: '18px'}}>Support</p>
          <a href="#">Contact us</a>
          <br />
        ...
        <div className="col" style={{lineHeight: '0.96cm'}}>
          <p style={{fontWeight: '700', fontSize: '18px'}}>Account</p>
      ...
      <div className="text-muted p-4 " style={{fontSize: '13px'}}>
        <p>
